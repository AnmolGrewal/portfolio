...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        My journey into the world of coding began in the summer of 2008, sparked by a passion for browser games and a desire to enhance my
        gaming experience. As an elementary school student, I taught myself Visual Basic 6 to create game trainers, allowing me to save
        progress in games that lacked built-in save features. This early experience ignited a lifelong fascination with programming and
        problem-solving.
      </p>

      <p className="mb-3">
        Fast forward to today, and I've transformed that childhood curiosity into a professional career. I've earned a degree in{' '}
        <span className="font-medium">Computer Science</span>, honing my skills and deepening my understanding of software development. What
      ...
      <p>
        Outside of coding, I'm an avid gamer, movie enthusiast, and proud dog owner. I believe in maintaining a healthy work-life balance
